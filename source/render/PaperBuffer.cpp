...
bool PaperBuffer::Ensure( GLsizei requestedWidth, GLsizei requestedHeight, GLint format, Filter filter )
{
...
void PaperBuffer::ClearTo( float r, float g, float b, float a )
{
	if( fboID == 0 )
		return;
