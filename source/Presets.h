...
/**
    ...
    **Standard parameters are the host-facing 0..1**, not engineering units --
    ...
    `kBlend` is in the table because a preset is a whole machine, pen
    included: a preset chosen while Lift was selected would otherwise draw
    nothing, which reads as a broken preset rather than as an eraser left in
    the hole. Every factory row is Multiply, the transparent pen.
...
inline constexpr Preset kPresets[] = {
	//   name                ring wheel mesh  pen     snapS snapH rate    det creep  skip   skipT lay chg wipe pen type bl inkR   inkG   inkB   flow    nib     spr    paper                grain  tooth   fade   figf prt zoom    gears
	{ "Classic Rosette", {     96,  52,   0, 0.770f,   1,    1,  0.737f,  1, 0.06f, 0.00f,   1,   4,  0,  1,   1,  0, 0,  0.72f, 0.10f, 0.12f, 0.625f, 0.398f, 0.10f, COGWHEEL_CARTRIDGE, 0.15f, 0.222f, 0.000f, 0,  0, 0.610f, 0.00f } },
	...
	{ "Three Lobes",     {     96,  32,   0, 0.973f,   1,    1,  0.466f,  2, 0.50f, 0.00f,   1,   1,  3,  0,   4,  0, 0,  0.34f, 0.34f, 0.36f, 0.699f, 0.287f, 0.05f, COGWHEEL_CARTRIDGE, 0.20f, 0.278f, 0.000f, 0,  0, 0.610f, 0.00f } },
	...
	{ "Dense Web",       {    105,  64,   0, 0.500f,   1,    1,  0.826f,  2, 0.02f, 0.00f,   1,   6,  2,  1,   3,  0, 0,  0.72f, 0.10f, 0.12f, 0.534f, 0.199f, 0.05f, COGWHEEL_CARTRIDGE, 0.10f, 0.111f, 0.000f, 0,  1, 0.610f, 0.00f } },
	...
	{ "Flower",          {     96,  45,   1, 0.838f,   1,    1,  0.667f,  1, 0.05f, 0.00f,   1,   6,  0,  1,   2,  0, 0,  0.72f, 0.10f, 0.12f, 0.625f, 0.398f, 0.20f, COGWHEEL_CARTRIDGE, 0.15f, 0.222f, 0.000f, 0,  0, 0.486f, 0.00f } },
	//Outside the ring: an epitrochoid, which is the petal shape rather than the
	//rosette. Six pens through six holes.

	{ "Slipping Gear",   {     96,  52,   0, 0.770f,   1,    0,  0.667f,  1, 0.45f, 0.30f,   3,   1,  3,  0,   0,  0, 0,  0.55f, 0.09f, 0.10f, 0.593f, 0.398f, 0.30f, COGWHEEL_CARTRIDGE, 0.25f, 0.389f, 0.374f, 0,  0, 0.610f, 0.00f } },
	...
	{ "Wet Trail",       {     96,  33,   0, 0.700f,   1,    0,  0.900f,  2, 0.03f, 0.00f,   1,   1,  3,  0,   3,  1, 0,  0.72f, 0.10f, 0.12f, 0.778f, 0.199f, 0.00f, COGWHEEL_CARTRIDGE, 0.08f, 0.111f, 0.855f, 0,  0, 0.610f, 0.00f } },
	...
	{ "Chalkboard",      {    105,  40,   0, 0.635f,   1,    1,  0.566f,  1, 0.08f, 0.00f,   1,   3,  0,  1,   4,  1, 0,  0.34f, 0.34f, 0.36f, 0.492f, 0.548f, 0.60f, COGWHEEL_CARTRIDGE, 0.55f, 0.667f, 0.000f, 0,  1, 0.564f, 0.00f } },
	...
	{ "Show the Gears",  {    144,  60,   0, 0.770f,   1,    1,  0.520f,  1, 0.04f, 0.00f,   1,   4,  0,  1,   1,  0, 0,  0.72f, 0.10f, 0.12f, 0.625f, 0.398f, 0.10f, COGWHEEL_CARTRIDGE, 0.15f, 0.222f, 0.000f, 0,  0, 0.596f, 0.75f } },
